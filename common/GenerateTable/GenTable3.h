...
void GenTable3::Fill(const SHypertriton3 &sHyp3, const REvent &rEv) {
  ...
  const double eDeu = hypot(sHyp3.fPxDeu, sHyp3.fPyDeu, sHyp3.fPzDeu, kDeuteronMass);
  const double eP   = hypot(sHyp3.fPxP, sHyp3.fPyP, sHyp3.fPzP, kProtonMass);
  const double ePi  = hypot(sHyp3.fPxPi, sHyp3.fPyPi, sHyp3.fPzPi, kPionMass);
